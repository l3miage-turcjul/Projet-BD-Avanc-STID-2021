...
$result = $pdo->query('SELECT `Titre`,`Nb_vues`,`Commentaires_disabled`,`Notes_disabled`,`Nb_jours_Tendance` FROM `Video`,`Chaine` WHERE Video.Chaine_ID=Chaine.ID_Chaine and `Notes_disabled`="VRAI" order by `Nb_jours_Tendance` DESC')
